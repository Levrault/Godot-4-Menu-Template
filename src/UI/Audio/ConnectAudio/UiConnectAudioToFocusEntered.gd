...
func _ready():
	...
	Events.connect("menu_transition_started",Callable(self,"_on_Menu_transition_started"))
	Events.connect("menu_transition_finished",Callable(self,"_on_Menu_transition_finished"))
	audio_player.owner.connect("focus_entered",Callable(self,"_on_Focus_entered"))
	audio_player.owner.connect("mouse_entered",Callable(self,"_on_Mouse_enter"))
