...
@export var alt_placeholder := "alt_placeholder" :
	get:
		return alt_placeholder # TODOConverter40 Non existent get function 
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_alt_placeholder
...
var last_focused_button: Button = null :
	get:
		return last_focused_button # TODOConverter40 Copy here content of _get_last_focused_button
	set(mod_value):
		mod_value  # TODOConverter40 Copy here content of _set_last_focused_button
...
func _apply_changes(key: String) -> void:
