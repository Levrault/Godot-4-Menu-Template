...
func _ready():
	await owner.ready
	Events.connect("gamepad_layout_changed",Callable(self,"_on_Gamepad_layout_changed"))
	Events.connect("gamepad_stick_layout_changed",Callable(self,"_on_Gamepad_stick_layout_changed"))
	Events.connect("locale_changed",Callable(self,"translate_buttons"))
	Events.connect("locale_changed",Callable(self,"translate_sticks"))
