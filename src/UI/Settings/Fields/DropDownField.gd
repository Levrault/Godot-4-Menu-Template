...
func _ready() -> void:
	...
	option_button.connect("focus_exited",Callable(self,"_on_Option_button_focus_exited"))
	option_button.connect("item_selected",Callable(self,"_on_Item_selected"))
	option_button.connect("item_focused",Callable(self,"_on_Item_focused"))
	option_button.get_popup().connect("about_to_popup",Callable(self,"_on_Popup_about_to_show"))
	option_button.get_popup().connect("popup_hide",Callable(self,"_on_Popup_hide"))
