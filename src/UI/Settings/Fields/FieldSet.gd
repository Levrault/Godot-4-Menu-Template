...
func _ready():
	...
	Events.connect("fieldset_inner_field_navigated",Callable(self,"_on_Fieldset_inner_field_navigated"))
	connect("mouse_exited",Callable(self,"_on_Mouse_exited"))
	connect("mouse_entered",Callable(self,"_on_Mouse_focus_entered"))
	field.connect("field_focus_entered",Callable(self,"_on_Field_focus_entered"))
	field.connect("field_focus_exited",Callable(self,"_on_Field_focus_exited"))


func clear() -> void:
	is_hovered = false
	Events.disconnect("fieldset_cleared",Callable(self,"_on_Field_cleared"))
...
func _on_Mouse_focus_entered() -> void:
	...
	Events.connect("fieldset_cleared",Callable(self,"_on_Field_cleared"))
	Events.emit_signal("fieldset_cleared", self)
