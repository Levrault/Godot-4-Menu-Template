...
# workaround to map mouse input to position key
const MOUSE_INDEX_TO_STRING := {
	"MOUSE_BUTTON_LEFT": "mouse.left_mouse_button",
	"MOUSE_BUTTON_RIGHT": "mouse.right_mouse_button",
	"MOUSE_BUTTON_MIDDLE": "mouse.middle_mouse_button",
	"MOUSE_BUTTON_XBUTTON1": "mouse.mouse_xbutton1",
	"MOUSE_BUTTON_XBUTTON2": "mouse.mouse_xbutton2",
	"MOUSE_BUTTON_WHEEL_UP": "mouse.wheel_up_mouse_button",
	"MOUSE_BUTTON_WHEEL_DOWN": "mouse.wheel_down_mouse_button",
	"MOUSE_BUTTON_WHEEL_LEFT": "mouse.wheel_left_mouse_button",
	"MOUSE_BUTTON_WHEEL_RIGHT": "mouse.wheel_right_mouse_button",
	"MOUSE_BUTTON_MASK_LEFT": "mouse.mask_left_mouse_button",
	"MOUSE_BUTTON_MASK_RIGHT": "mouse.mask_right_mouse_button",
	"MOUSE_BUTTON_MASK_MIDDLE": "mouse.mask_middle_mouse_button",
	"MOUSE_BUTTON_MASK_XBUTTON1": "mouse.mask_xbutton1_mouse_button",
	"MOUSE_BUTTON_MASK_XBUTTON2": "mouse.mask_xbutton2_mouse_button"
}

var gamepad_regex := {"xbox": "_XBOX_", "nintendo": "_DS_", "dualshock": "_SONY_"}

# contains data of all super.cfg file from engine folder
var data := {}
...
func _read_keyboard_ui_file() -> void:
	...
	for action in default_keyboard_ui_scheme:
		for key in default_keyboard_ui_scheme[action]:
			...
			input_event_key.set_keycode(keylist.keyboard[key])
